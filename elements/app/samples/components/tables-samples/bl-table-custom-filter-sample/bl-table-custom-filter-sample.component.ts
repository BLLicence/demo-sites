...
// ADD OPEN FILTER BUTTON
    ...
    private setFooterPageData() {
        let dataLengh = this.datasource.data.length;
        this.footerRow = {id: 'Total', nom: dataLengh +' nom(s)', prenom: dataLengh + ' prénom(s)', vr: '', 'adresse.city': ''};
