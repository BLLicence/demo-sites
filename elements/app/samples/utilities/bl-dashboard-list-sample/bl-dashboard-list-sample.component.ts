...
export class BlDashboardListSampleComponent implements  OnInit{
    ...
    setData2(){
        ...
        this.eventData.set('FD2', {value: ['Dustin', 'Poirier','DNR2002 sqsffsqfsfsqsqffsqqsfsqf sqsffsqfsfsqsqffsqqsfsqf sqsffsqfsfsqsqffsqqsfsqf sqsffsqfsfsqsqffsqqsfsqf','F333']});
