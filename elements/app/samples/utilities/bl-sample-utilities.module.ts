...
import {
    ...
    BlDatepickerModule, BlDecimalFieldModule,
...
import { BlNotificationModalModule } from '../../../../../../libs/shared-ui/src/lib/components/basic/bl-notification-modal/bl-notification-modal.module';
import { BlCustomErrorSampleComponent } from './bl-custom-error-sample/bl-custom-error-sample.component';

const SAMPLE_COMPONENTS = [
  BlActionBannerSampleComponent,
  BlCloseAlertSampleComponent,
  BlFormErrorSampleComponent,
  BlCustomErrorSampleComponent,
...
@NgModule({
  declarations: [SAMPLE_COMPONENTS],
    ...
    exports: [SAMPLE_COMPONENTS, BlCustomErrorSampleComponent],
})
