...
import { ThemeService } from '@bl/theme';
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    this.matIconRegistry.addSvgIcon(
      ...
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/theImages/Datepicker/calendar-blank-fill.svg'
      )
    )
    this.matIconRegistry.addSvgIcon(
      'date_check_in2',
      this.domSanitizer.bypassSecurityTrustResourceUrl(
        'assets/theImages/Datepicker/calendar-material-light.svg'
      )
    )
  }
  ...
  updateIcon() {
    if (this.themeService.activeTheme == 'tertiary-palette-bl') {
      this.dateIcon = 'date_check_in';

    } else {
      this.dateIcon = 'date_check_in2';
    }
  }
}
